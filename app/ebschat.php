		  ...
		  <div class="container">
			<div class="chat_container">
				<div class="col-sm-3 hidden-xs chat_sidebar">
					<h4>Hola <?php print @$_SESSION['firstName'];?>, <br/>Estas usando una demo del bot de citas.</h4>
               <p>IA - ITSLP</p>
				</div>
				...
				<div class="col-sm-3 hidden-xs chat_sidebar">
               <br>
               <a class="btn btn-success" href="<?php echo base_url('app/ajax/conversation_start.php');?>">Reiniciar Conversación</a>
